...
(function() {
  ...
  createTable = function(tableData, columns, distroList, lootList) {
    var $table, $thr, $tr, accounts, cl, currentPriority, data, distroPriority, drop, e, gets, i, item, lastcat, name, num, row, row_list, text, wishes, _i, _j, _k, _len, _len1, _len2, _ref;
    $table = $("<table/>");
  ...
  window.getWishes = function(distroList, bossKills, lootList, callback) {
    ...
    doitall = function(d) {
      var getList, row, rowList, tableData, _j, _len1;
