...
(function() {
  var AllPlayers, Blacklist, ChartResult, ElementList, Loot, MakeLootTable, MonsterList, NewTally, PointValue, Points, Process, RunPlayers, Wishlist, accounts, banishSearch, bossKills, bossMatch, calcCum, checkBlacklist, cumPoints, distroSearch, elSearch, getAccountName, importantItems, instanceSummary, keySearch, kissMatch, logit, lootCount, looters, loseSearch, miscNC, monsterAlias, onceChecklist, outfit, playerSearch, quickReport, search, sheetSearch, staff, styleElement, thisRunPoints, worthyTasks;
  ...
  */
  ...
  ChartResult = function(accounts, total) {
    var AddRow, SetRow, account, base_match, base_name, cumArray, cumData, data, distroArea, distroList, lootHtml, name, pointsOut, row, runData, score, table, tally, wishlink, _i, _j, _len, _len1;
  ...
  MakeLootTable = function(RunPlayers, getList) {
    var account, base_match, base_name, gets, lootHtml, name, row, wishlink, _i, _len;
    lootHtml = "<table id='lootTable'>";
    ...
    return $("#distro-blurb").text("(Items are suggestions only)");
  };
