...
Crafty.extend({
    ...
    raycast: function(origin, direction) {
        ...
        if (maxDistance < 0) { // find first intersection
            ...
            console.log('yup, starting');
            // traverse map
            Crafty.map.traverseRay(origin, direction, function(obj, setNumber) {
                console.log('bing', obj, setNumber);
                // TODO max distance is now built in to ray traversal algo

                // check if we advanced to next cell
                //      then cancel traversal if previousCellDistance > maxDistance
                // if (setNumber > maxDistance) {
                //     return true;
                // }
