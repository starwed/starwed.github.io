...
(function() {
  var BlockGrid, Clamp, Crafty, Di, Direction, FindFriends, XOffset, YOffset, bail, checkUnmaker, clickControl, getBlock, jumpSound, newUnmaker, randomType, setBlock, setup, sliceSprites, spriteList, typeList, xcell, ycell;
  ...
  Crafty.c("Unmaker", {
    init: function() {
      ...
      this.bind("Moved", this._checkGround);
      return Crafty.viewport.follow(this);
    },
