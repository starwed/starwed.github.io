...
(function() {
  var BlockGrid, Clamp, Crafty, Di, Direction, FindFriends, XOffset, YOffset, bail, checkUnmaker, clickControl, fillBlocks, getBlock, jumpSound, newUnmaker, randomType, randomUnmakerType, setBlock, setup, sliceSprites, spriteList, typeExtant, typeList, xcell, ycell;
  ...
  Crafty.c("Unmaker", {
    init: function() {
      this.requires("2D, DOM, Sprite, Ballistic, Collision, KeyboardMan, Snap, Solid, Bounce").attr({
        h: 32,
        w: 32
  ...
  fillBlocks = function() {
    ...
    Crafty("redbubble").each(function() {
      return this.destroy();
    });
