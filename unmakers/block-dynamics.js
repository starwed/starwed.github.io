...
(function() {
  ...
  Crafty.c("Movable", {
    ...
    detach: function(e) {
      ...
      e.carry_parent = null;
      i = this.carried.indexOf(e);
      if (i >= 0) {
        return this.carried.splice(i, 1);
      }
    },
    unglue: function(e) {
      var i;
    ...
    setFree: function() {
      if (this.glue_parent != null) {
        return this.glue_parent.unglue(this);
      } else if (this.carry_parent != null) {
        return this.carry_parent.detach(this);
      }
    },
    getGlueTop: function() {
      if (this.glue_parent != null) {
  ...
  Crafty.c("Supportable", {
    ...
    _checkSupport: function() {
      ...
      if (this.feet.hit('Platform')) {
        this.grounded = true;
        groundBlock = Crafty(this.feet.hit('Platform')[0].obj[0]);
        return this._ay = 0;
      } else {
        this.grounded = false;
        this.setFree();
