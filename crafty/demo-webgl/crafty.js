...
Crafty.extend({
    ...
    _commonLayerProperties: {
        ...
        viewportRect: function () {
            ...
            rect._x = -Crafty.viewport._x * options.xResponse;
            rect._y = -Crafty.viewport._y * options.yResponse;
            rect._w = Crafty.viewport._width / scale;
            rect._h = Crafty.viewport._height / scale;
