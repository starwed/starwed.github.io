 function run(){
      ...
      var comps = ["MyWebGL", "MyDOM", "MyCanvas"]
      
      // LAYER CREATION ------
      Crafty.createLayer("MyWebGL1", "WebGL", {scaleResponse: 1, z: 1});
      Crafty.createLayer("MyDOM1", "DOM", {scaleResponse: 2, z:2});
      Crafty.createLayer("MyCanvas1", "Canvas", {scaleResponse: 3, z:3});
      
      Crafty.createLayer("MyWebGL", "WebGL", {scaleResponse: 1, z:4});
      Crafty.createLayer("MyDOM", "DOM", {scaleResponse: 2, z:5});
      Crafty.createLayer("MyCanvas", "Canvas", {scaleResponse: 3, z:6});
      ...
      for (var m=0; m<comps.length; m++){
        ...
        // label text
        var e = Crafty.e("2D, MyDOM, Text").attr({x:x_0, y:y_0, z:3, w:100}).textColor("yellow").text(render);
        ...
        //Background image
        var b1 = comp(render + "1", "Image, Schedule").image("starynight.png", "repeat").attr({x:x_0, y:y_0, w:1024, z:0, h:256});
