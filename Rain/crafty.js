...
Crafty.c("2D", {
    ...
    // A separate setter for the common case of moving an entity along both axis
    _setXAndY: function(x, y) {
...
Crafty.c("Motion", {
    ...
    _linearMotionTick: function(frameData) {
        ...
        this._setXAndY(this._x + dx, this._y + dy);
...
HashMap.prototype = {
     ...
     */
     _searchHolder: [],
    search: function (rect, finalResults) {
    ...
    unfilteredSearch: function(rect, finalResults) {
        var keys = HashMap.key(rect, keyHolder),
            i, j, k,  cell;
        finalResults = finalResults || [];
