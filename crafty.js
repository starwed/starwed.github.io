...
Crafty.extend({
    ...
    viewport: {
        ...
        zoom: (function () {
            ...
            var startingZoom, finalZoom, startingX, finalX, startingY, finalY, easing;
            ...
            function enterFrame(e){
                ...
                Crafty.scale( startingZoom * (1-v) + finalZoom * v);
                Crafty.scroll("_x", startingX * (1-v) + finalX * v);
                Crafty.scroll("_y", startingY * (1-v) + finalY * v);
            ...
            return function (amt, cent_x, cent_y, time){    
                ...
                finalZoom = Crafty.viewport._zoom * amt;

                startingX = Crafty.viewport.x;
                startingX = Crafty.viewport.y;
                finalX = cent_x - Crafty.viewport.w / (2 * amt);
                finalY = cent_y - Crafty.viewport.h / (2 * amt);
         ...
         * Zooming/scaling is not multiplicative. To reset the zoom/scale amount, pass 0.
         *
         * @example
         * ~~~
        ...
        mouselook: (function () {
            ...
            Crafty.bind("CameraStop", stopLook);
